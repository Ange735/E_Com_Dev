...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add') {
        ...
        $stmt = $pdo->prepare("SELECT id, seller_id, stock FROM products WHERE id = ? AND status = 'active'");
        $stmt->execute([$pid]);
        $prod = $stmt->fetch();
        ...
        header('Location: /buyer/cart.php'); exit;
    }
  ...
  <div class="container">
    ...
    <div class="cart-layout">
      ...
      <div>
        <form method="post" action="/buyer/cart.php">
              ...
              <div style="display:flex;align-items:center;justify-content:space-between;margin-top:.8rem;flex-wrap:wrap;gap:.5rem;">
                ...
                <div style="display:flex;align-items:center;gap:1rem;">
                  ...
                  <form method="post" action="/buyer/cart.php" style="display:inline;">
                    ...
                    <button type="submit" class="cart-remove">✕ Retirer</button>
                  </form>
                </div>
              </div>
            </div>
          ...
          <div style="display:flex;justify-content:space-between;margin-top:1rem;flex-wrap:wrap;gap:.8rem;">
            <button type="submit" class="btn btn-secondary btn-sm">Mettre à jour le panier</button>
            <form method="post" action="/buyer/cart.php">
        ...
        <div style="margin-top:1.5rem;"><a href="/shop.php" style="color:var(--green-lt);font-size:.83rem;">← Continuer mes achats</a></div>
      </div>
      ...
      <div class="order-summary">
        ...
        <a href="/buyer/checkout.php" class="btn btn-primary btn-full btn-lg" style="margin-top:1rem;">
          Passer commande →
        </a>
