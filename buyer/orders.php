...
<div class="page-wrap">
  <div class="container">
    <nav class="breadcrumb"><a href="/">Accueil</a><span class="sep">/</span><span>Mes commandes</span></nav>
    <h1 class="section-title">📦 Mes commandes</h1>

    <?php if (empty($orders)): ?>
    <div style="text-align:center;padding:4rem;color:var(--muted);">
      <div style="font-size:3rem;margin-bottom:1rem;">📭</div>
      <p>Aucune commande pour l'instant. <a href="/shop.php" style="color:var(--green-lt);">Explorer le catalogue</a></p>
    </div>
    <?php else: ?>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="/buyer/order-detail.php?id=<?= $o['id'] ?>" class="btn btn-secondary btn-sm">Détails</a></td>
          </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
